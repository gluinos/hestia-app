        ...
        <FadeContent>
          <Container className="d-flex" style={{ paddingTop: "25px" }}>
            <Row className="w-100 text-center">
              <Col md="4">
                <Bubble><a href="#"><figure class="figure">
                  <img src="https://via.placeholder.com/150" alt="..." class="rounded-circle"/>
                  <figcaption class="figure-caption">Helping People</figcaption>
                </figure></a></Bubble>
              </Col>
              <Col md="4">
                <Bubble><a href="#"><figure class="figure">
                  <img src="https://via.placeholder.com/150" alt="..." class="rounded-circle"/>
                  <figcaption class="figure-caption">Helping Shelters</figcaption>
                </figure></a></Bubble>
              </Col>
              <Col md="4">
                <Bubble><a href="#"><figure class="figure">
                  <img src="https://via.placeholder.com/150" alt="..." class="rounded-circle"/>
                  <figcaption class="figure-caption">Helping Everyone</figcaption>
                </figure></a></Bubble>
              </Col>
            </Row>
          </Container>
